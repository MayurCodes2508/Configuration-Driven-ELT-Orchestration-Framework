...
class Api:
    def __init__(self, ingestion_cfg, url):
        ...
        auth_cfg = ingestion_cfg.get("auth")
        ...
        self.auth_cfg = ingestion_cfg["auth"]
    ...
    def build_url(self):
        ...
        try:
            full_url = f"{self.root_url}{self.ingestion_cfg['path']}"
    ...
    def run(self):
        ...
        data, rows_ingested = self.handle_response(response=response)

        job_metrics = {"rows_ingested": rows_ingested}
